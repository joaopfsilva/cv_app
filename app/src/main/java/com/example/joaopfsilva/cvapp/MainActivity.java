    ...
    public class MainActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            getSupportActionBar().setTitle("Tech Startup Job Fair Amsterdam");
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(emailReceiver.isEmpty()){
                        Toast.makeText(getApplicationContext(), "Insert email!!",
                                Toast.LENGTH_SHORT).show();
                    } else if (!emailReceiver.contains("@")){
                        Toast.makeText(getApplicationContext(), "Invalid email!!",
                                Toast.LENGTH_SHORT).show();
                    } else {
                        Uri uri = Uri.parse("mailto:");
                        Intent myActivity2 = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:"+emailReceiver));
                       // myActivity2.putExtra(Intent.EXTRA_EMAIL, emailReceiver);
